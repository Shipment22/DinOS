class PizzaGui {
    ...
    drawDock() { // draws dock (currently usless)
        ...
        this.p.rect(this.dockX + this.dockHeight + this.dockHeight * a[a.length - 1].i - 3, this.dockY, this.dockHeight, this.dockHeight, 7);
        for (let o of dinos.memory.activitys[currActivity].apps) {
    ...
    dockPress() {
        ...
        for (let i in dinos.memory.activitys[currActivity].apps) {
            ...
            if (this.mouseIsOver(this.dockX + this.dockHeight + this.dockHeight * o.i, this.dockY + 3, this.dockHeight - 6, this.dockHeight - 6)) {
                ...
                this.p.fill(0, 200);
            this.p.rect(this.dockX + this.dockHeight + this.dockHeight * o.i, this.dockY + 3, this.dockHeight - 6, this.dockHeight - 6);
